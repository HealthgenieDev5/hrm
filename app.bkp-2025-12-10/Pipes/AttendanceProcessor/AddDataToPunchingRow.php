...
class AddDataToPunchingRow
{
    ...
    public function handle($punching_row, Closure $next)
    {
        ...
        if (!empty($punching_row['in_time'])) {
            ...
            $punching_row['late_coming_minutes']    = ProcessorHelper::get_late_coming_minutes($punching_row['shift']['shift_start'], $punching_row['in_time__Raw']);
        }
        ...
        if (!empty($punching_row['out_time'])) {
            ...
            $punching_row['early_going_minutes']    = ProcessorHelper::get_early_going_minutes($punching_row['shift']['shift_end'], $punching_row['out_time__Raw'], $punching_row['in_time__Raw']);
        ...
        $punching_row['od_hours_between_shifts'] = ProcessorHelper::get_od_hours_between_shifts($punching_row['date'], $punching_row['shift']['shift_start'], $punching_row['shift']['shift_end'], $punching_row['employee_id'], 'hours');
        ...
        if ($punching_row['is_absent'] == 'yes') {
            ...
            if (strtotime($punching_row['shift']['shift_start']) > strtotime($punching_row['shift']['shift_end'])) {
                $late_coming_plus_early_going_minutes_adjustable_day1 = ProcessorHelper::get_time_difference($punching_row['shift']['shift_start'], '23:59', 'minutes');
                $late_coming_plus_early_going_minutes_adjustable_day2 = ProcessorHelper::get_time_difference('00:00', $punching_row['shift']['shift_end'], 'minutes');
                ...
                $punching_row['late_coming_plus_early_going_minutes_adjustable'] = ProcessorHelper::get_time_difference($punching_row['shift']['shift_start'], $punching_row['shift']['shift_end'], 'minutes') - 30;
            }

            /*if( session()->get('current_user')['employee_id'] == '40' && $employee_id == '407' && $punching_row['date'] == '2025-01-20' ){
                echo $punching_row['late_coming_plus_early_going_minutes_adjustable'] . '<br>'; 
                echo $punching_row['shift']['shift_start'] . '<br>'; 
                echo $punching_row['shift']['shift_end'] . '<br>'; 
                echo $late_coming_plus_early_going_minutes_adjustable_day1 . '<br>'; 
                echo $late_coming_plus_early_going_minutes_adjustable_day2 . '<br>'; 
                die();
            }*/
