...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url('public'); ?>/assets/plugins/custom/datatables/fixedColumns.dataTables.min.css" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor Stylesheets-->


		<link href="<?php echo base_url('public'); ?>/assets/plugins/custom/jstree/jstree.bundle.css" rel="stylesheet" type="text/css" />
		...
		<!-- Tempus Dominus Styles -->
		<!-- <link href="https://cdn.jsdelivr.net/gh/Eonasdan/tempus-dominus@master/dist/css/tempus-dominus.css" rel="stylesheet" crossorigin="anonymous"> -->
		<!-- <link href="<?php echo base_url('public'); ?>/assets/plugins/custom/datetimepicker/css/tempusdominus-bootstrap-4.css" rel="stylesheet" type="text/css" /> -->
		...
		<link href="<?php echo base_url('public'); ?>/assets/plugins/custom/md/mdtimepicker.css" rel="stylesheet" type="text/css" />
		<!-- Tempus Dominus Styles -->
		...
		<link href="<?php echo base_url('public'); ?>/assets/plugins/custom/bootstrap5-dt-picker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
		...
		<!--begin::Toggle Switch-->
		<link href="<?php echo base_url('public'); ?>/assets/css/toggle-switch.css" rel="stylesheet" type="text/css" />
		<!--end::Toggle Switch-->
