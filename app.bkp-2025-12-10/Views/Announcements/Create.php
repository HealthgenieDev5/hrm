                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="target_type" name="target_type" required>
                                ...
                                <option value="department" <?= old('target_type') === 'department' ? 'selected' : '' ?>>Specific Departments</option>
                                <option value="designation" <?= old('target_type') === 'designation' ? 'selected' : '' ?>>Specific Designations</option>
                                <option value="specific" <?= old('target_type') === 'specific' ? 'selected' : '' ?>>Specific Employees</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3" id="target_designations_div" style="display: none;">
                            ...
                            <select class="form-select" id="target_designations" name="target_designations[]" multiple size="5">
                                <?php foreach ($designations as $desig): ?>
                                    <option value="<?= $desig['id'] ?>"><?= esc($desig['designation']) ?></option>
                                <?php endforeach; ?>
                            </select>
                            <small class="text-muted">Hold Ctrl to select multiple</small>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="requires_acknowledgment" name="requires_acknowledgment"
                                   value="1" <?= old('requires_acknowledgment', '1') ? 'checked' : '' ?>>
                    ...
                    <div class="col-md-4">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" id="show_once" name="show_once"
                                   value="1" <?= old('show_once', '1') ? 'checked' : '' ?>>
