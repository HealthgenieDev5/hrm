...
<div class="row gy-5 g-xl-8">
    ...
    <div class="col-xl-12">
        <table id="loyalty_incentive_report_table" class="table table-striped nowrap">
            <thead>
                <tr>
                    ...
                    <th class="text-center"><strong>Starting Date</strong></th>
                    <th class="text-center"><strong>End Date</strong></th>
                    <th class="text-center"><strong>Monthly Amount</strong></th>
                    <th class="text-center"><strong>Mature after X Month</strong></th>
                    <th class="text-center"><strong>Pay after X Month</strong></th>

                    <th class="text-center"><strong>Salary Month</strong></th>
...
<script type="text/javascript">
    jQuery(document).ready(function($){
        ...
        /*begin::loyalty_incentive_report_table*/
        var loyalty_incentive_report_table = $("#loyalty_incentive_report_table").DataTable({
            ...
            "ajax": {
                url:  "<?= base_url('ajax/backend/reports/get-loyalty-incentive-report') ?>",
                type:  "POST",
            ...
            "columns": [
                ...
                { data: "loyalty_incentive_from" },
                { data: "loyalty_incentive_to" },
                { data: "loyalty_incentive" },
                { data: "loyalty_incentive_mature_after_month" },
                { data: "loyalty_incentive_pay_after_month" },
                { data: "month" },
                { data: "working_days" },
                { data: "payable" },
                { data: "bank_account" }
        ...
        $('#loyalty_incentive_report_table_wrapper > .card > .card-header > .card-title').replaceWith('<h3 class="card-title">Loyalty Incentive Report</h3>');
        /*end::loyalty_incentive_report_table*/
