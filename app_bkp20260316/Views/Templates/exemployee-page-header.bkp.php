	...
	<div class="container-fluid d-flex align-items-stretch justify-content-between">
		...
		<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
			<a href="<?php echo base_url(); ?>" class="d-lg-none">
				<!-- <img alt="Logo" src="<?php #echo base_url('public'); ?>/assets/media/logos/logo-2.svg" class="h-30px" /> -->
				<img alt="Logo" src="<?php echo base_url('public'); ?>/assets/media/logos/logo-healthgenie.png" class="h-30px logo" />
			</a>
		</div>
		<!--end::Mobile logo-->
		<!--begin::Wrapper-->
							...
							<div class="menu-content d-flex align-items-center px-3">
								...
								<div class="d-flex flex-column">
									<div class="fw-bolder d-flex flex-column align-items-baseline fs-5">
										<span><?= $ExEmployee['name'] ?></span><br>
										<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-0"><?= $ExEmployee['role'] ?></span>
									</div>
									<a href="#" class="fw-bold text-muted text-hover-primary fs-7"><?= $ExEmployee['work_email'] ?></a>
								</div>
								<!--end::Username-->
							</div>
						</div>
