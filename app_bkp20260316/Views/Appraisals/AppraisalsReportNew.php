...
<div class="appraisal" style="background-color: #f9f9f9; ">
    <table width="100%" cellspacing="0" cellpadding="6" style="border-collapse:collapse;">
        <tr>
            <td rowspan="4" style="width:140px; text-align:center; vertical-align:middle;">
                <img src="<?= $arrAppraisalData[$employee_id]['logo_url'] ?>"
                    alt="Logo"
                    style="max-width:120px; height:auto;">
            </td>

            <td colspan="2" rowspan="2" style="text-align:center; font-weight:bold;">
                <?= $arrAppraisalData[$employee_id]['company_name'] ?>
            </td>

            <td rowspan="3" style="width:260px; padding:0;">
                <table width="100%" cellspacing="0" cellpadding="4" style="border-collapse:collapse;">
                    <tr>
                        <td style="text-align:left; font-weight:bold;">Format No.</td>
                        <td style="text-align:left;">F/HR/34</td>
                    </tr>
                    <tr>
                        <td style="text-align:left; font-weight:bold;">Issue Date</td>
                        <td style="text-align:left;">07-04-2024</td>
                    </tr>
                    <tr>
                        <td style="text-align:left; font-weight:bold;">Next Review date</td>
                        <td style="text-align:left;">06-04-2027</td>
                    </tr>
                    <tr>
                        <td style="text-align:left; font-weight:bold;">Revision No.</td>
        ...
        <tbody>
            ...
            foreach ($arrAppraisalData[$employee_id]['appraisals'] as $appraisal) : ?>
                <tr>
                    ...
                    <td><?= ($appraisal['pf'] == 'no') ? 0 : esc($appraisal['pf_employee_contribution']) ?></td>
                    <td><?= ($appraisal['esi'] == 'no') ? 0 : esc($appraisal['esi_employee_contribution']) ?></td>
                    <td><?= ($appraisal['lwf'] == 'no') ? 0 : esc($appraisal['lwf_employee_contribution']) ?></td>
                    <td><?= esc($appraisal['in_hand_salary']) ?></td>
                    <td><?= ($appraisal['pf'] == 'no') ? 0 : esc($appraisal['pf_employer_contribution']) ?></td>
                    <td><?= ($appraisal['esi'] == 'no') ? 0 : esc($appraisal['esi_employer_contribution']) ?></td>
                    <td><?= ($appraisal['lwf'] == 'no') ? 0 : esc($appraisal['lwf_employer_contribution']) ?></td>
                ...
                <?php if ($i > 0) : ?>
                    <tr style="font-weight: bold;  background-color:#211da22b;">
                        ...
                        <td><?= ($appraisal['pf'] == 'no') ? 0 : esc($appraisal['pf_employee_contribution_total']) ?></td>
                        <td><?= ($appraisal['esi'] == 'no') ? 0 : esc($appraisal['esi_employee_contribution_total']) ?></td>
                        <td><?= ($appraisal['lwf'] == 'no') ? 0 : esc($appraisal['lwf_employee_contribution_total']) ?></td>
                        <td><?= esc($appraisal['in_hand_salary_total']) ?></td>
                        <td><?= ($appraisal['pf'] == 'no') ? 0 : esc($appraisal['pf_employer_contribution_total']) ?></td>
                        <td><?= ($appraisal['esi'] == 'no') ? 0 : esc($appraisal['esi_employer_contribution_total']) ?></td>
                        <td><?= ($appraisal['lwf'] == 'no') ? 0 : esc($appraisal['lwf_employer_contribution_total']) ?></td>
