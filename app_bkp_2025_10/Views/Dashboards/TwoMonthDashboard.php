    ...
    jQuery(document).ready(function($){
        ...
        var late_coming_early_going_late_going_table = $("#late_coming_early_going_late_going_table").DataTable({
            ...
            "columnDefs": [
                ...
                { "className": 'text-center bg-danger bg-opacity-25', "targets": [1,2,3,4] },
                { "className": 'text-center bg-warning bg-opacity-25', "targets": [5,6,7,8] },
                { "className": 'text-center bg-success bg-opacity-25', "targets": [9,10,11,12] }
            ],
        });
