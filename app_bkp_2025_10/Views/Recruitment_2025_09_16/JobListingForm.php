    ...
    <form action="<?= $form_action ?>" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="min_experience" name="min_experience" placeholder=" " required>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="max_experience" name="max_experience" placeholder=" " required>
                        <span class="input-group-text">year</span>
            ...
            <div class="col-md-3">
                <div class="form-floating mb-3">
                    <!-- <select class="form-select" id="job_location" name="job_location" required>
                        ...
                        <option value="Head Office Okhla - New Delhi">Head Office Okhla - New Delhi</option>
                        ...
                        <div class="card w-100 rounded-0">
                                    ...
                                    <div class="col-md-12 align-items-center bg-light-success rounded p-5 mb-7">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="technical_test" id="technical_yes" value="Yes" required>
                                                <label class="form-check-label" for="technical_yes">Yes</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="technical_test" id="technical_no" value="No" required>
                            ...
                            <input type="text" class="form-control" id="technicalTestName" placeholder="Specify technical test name (e.g., Coding Test, Algorithm Test)">
                                    ...
                                    <div class="col-md-12 align-items-center bg-light-warning rounded p-5 mb-7">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="iq_test" id="iq_yes" value="Yes" required>
                                                <label class="form-check-label" for="iq_yes">Yes</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="iq_test" id="iq_no" value="No" required>
                                    ...
                                    <div class="col-md-12 align-items-center bg-light-danger rounded p-5 mb-7">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="english_test" id="english_yes" value="Yes" required>
                                                <label class="form-check-label" for="english_yes">Yes</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="english_test" id="english_no" value="No" required>
                                    ...
                                    <div class="col-md-12 align-items-center bg-light-info rounded p-5 mb-7">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="operation_test" id="operation_yes" value="Yes" required>
                                                <label class="form-check-label" for="operation_yes">Yes</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="operation_test" id="operation_no" value="No" required>
                                    ...
                                    <div class="col-md-12 align-items-center bg-light-success rounded p-5 mb-7">
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="other_test" id="other_yes" value="Yes" required>
                                                <label class="form-check-label" for="other_yes">Yes</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="other_test" id="other_no" value="No" required>
