            ...
            <div class="card shadow-sm mb-5">
                ...
                <div class="card-body">
                    <table id="wave_off_minutes_table" class="table table-sm table-hover table-striped table-row-bordered nowrap">
                        ...
                        <tbody>
                            <?php
                            foreach( $allAttendanceOverrideEntries as $AttendanceOverrideEntry){
                            ?>
                                <tr>
                                    <td class="text-center bg-white">
                                        <?php echo $AttendanceOverrideEntry['employee_id']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $AttendanceOverrideEntry['employee_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $AttendanceOverrideEntry['internal_employee_id']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $AttendanceOverrideEntry['company_short_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $AttendanceOverrideEntry['department_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo date('d M, Y', strtotime($AttendanceOverrideEntry['attendance_date'])); ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $AttendanceOverrideEntry['attendance']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <p class="text-wrap mx-auto mb-0 lh-sm" style="width: 150px"><small><?php echo $AttendanceOverrideEntry['remarks']; ?></small></p>
                                    </td>
                                    <td class="text-center bg-white">
