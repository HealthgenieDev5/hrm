        ...
        <div class="card shadow-sm">
            <div class="card-header">
                ...
                <div class="card-toolbar d-flex flex-column align-items-end">
                    <!-- <a class="btn btn-sm btn-light-primary" data-bs-toggle="modal" href="#create_loan_request_modal" >
                            <i class="fa fa-plus" ></i> Create New Request
                        </a> -->
                    <!-- <small class="text-muted">Loan request are disabled, Please check back in an hour</small> -->
                    <div class="modal fade" tabindex="-1" id="create_loan_request_modal">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                <form id="create_loan_request" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    <input type="number" min="0" step="0.01" id="loan_amount" class="form-control" name="loan_amount" placeholder="Loan Amount" value="<?= set_value('loan_amount') ?>" style="border-top-right-radius: 0; border-bottom-right-radius: 0;">
                                                    <span class="input-group-text input-group-solid">
                                                        <i class="fa-solid fa-indian-rupee-sign"></i>
                                                    </span>
                                                </div>
                                                <small class="text-danger error-text" id="loan_amount_error"><?= isset($validation) ? display_error($validation, 'loan_amount') : '' ?></small>
                                            </div>
                                            <div class="col-lg-6 mb-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <select class="form-select form-select-sm" id="reason" name="reason" data-control="select2" data-placeholder="Select Reason">
                                                    ...
                                                    <option value="salary_delay">Salary Delay</option>
                                                </select>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button id="create_loan_request_submit_button" class="btn btn-sm btn-primary">Add</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '#create_loan_request_submit_button', function(e) {
            e.preventDefault();
            var form = $('#create_loan_request');
            var data = new FormData(form[0]);
            $.ajax({
                method: "post",
                url: "<?php echo base_url('/ajax/create-loan-request'); ?>",
                data: data,
                processData: false,
                contentType: false,
