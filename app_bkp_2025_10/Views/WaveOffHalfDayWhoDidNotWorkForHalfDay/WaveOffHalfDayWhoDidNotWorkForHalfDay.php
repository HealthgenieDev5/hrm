...
<div class="row gy-5 g-xl-8">
    ...
    <div class="col-12">
        ...
        <div class="card shadow-sm mb-5">
            <form id="wave_off_half_day_who_did_not_work_for_half_day_form" class="card-body" method="post" enctype="multipart/form-data">
                <!-- <div class="card-body"> -->
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <button type="submit" id="submit_update_wave_off_half_day_who_did_not_work_for_half_day" class="form-control form-control-sm btn btn-sm btn-primary d-inline">
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $(document).on('submit', '#wave_off_half_day_who_did_not_work_for_half_day_form', function(e) {
            e.preventDefault();
            var form = $(this);
            ...
            $.ajax({
                method: "post",
                url: "<?php echo base_url('/ajax/backend/hr/update-half-day-consideration'); ?>",
                data: data,
                processData: false,
                contentType: false,
        ...
        var existing_overrides = $("#existing_overrides").DataTable({
            "buttons": [],
            "ajax": {
                url: "<?= base_url('/ajax/backend/hr/existing-half-day-consideration') ?>",
                type: "POST",
                data: {
                    filter: function() {
                        return $('#wave_off_half_day_who_did_not_work_for_half_day_form').serialize();
                    }
                },
                dataSrc: "",
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return `<div class="d-flex justify-content-center">
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-half-day-consideration" data-id="${row.id}">
        ...
        $(document).on('click', '.delete-half-day-consideration', function(e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        method: "post",
                        url: "<?php echo base_url('/ajax/backend/hr/delete-half-day-consideration'); ?>",
                        data: data,
                        success: function(response) {
                            console.log(response);
                            if (response.response_type == 'error') {
