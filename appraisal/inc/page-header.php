  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="search-bar">
      ...
      <?php
      if( in_array( $_SESSION['login']['user_role'], array('tl', 'hod', 'admin', 'superuser') ) ){
        ?><a href="<?php echo SITE_URL; ?>/admin.php" class="btn btn-sm btn-outline-danger" style="">Admin Panel</a><?php
      }
      ?>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <!-- <span class="rounded-circle text-center shadow" style="width: 20px; height: 20px; line-height: 20px;"><?php echo isset($_SESSION['login']) ? substr($_SESSION['login']['first_name'], 0, 1) : ''; ?></span> -->
