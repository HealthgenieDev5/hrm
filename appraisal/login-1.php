                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form id="login_form" class="row g-3">
                                    <div class="col-12">
                                        <label for="user_email" class="form-label required">Your Email</label>
                                        <input type="user_email" name="user_email" class="form-control" id="user_email" placeholder="Ente your email" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="password" name="user_pass" class="form-control" id="user_pass" placeholder="Ente your password" required>
                                        <div class="valid-feedback"></div>
                                        <div class="invalid-feedback"></div>
                                    </div>
		...
		$(document).on('submit', '#login_form', function(e){
			...
			if( user_email.length >= 6 ){
				if( user_pass.length >= 6 ){
					...
					jQuery.ajax({
						url: '<?php echo SITE_URL."/controller/ajax/ajax-validate-login-with-password.php"; ?>',
						type: 'POST',
						data:  data,
						dataType: 'html',
					})
				...
				alert('Email should be minimum 6 charecters');
				button.attr('disabled', false);
				button.removeClass('loading');
			}
