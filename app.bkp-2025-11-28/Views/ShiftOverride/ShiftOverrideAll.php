            ...
            <div class="card shadow-sm mb-5">
                ...
                <div class="card-body">
                    <table id="wave_off_minutes_table" class="table table-sm table-hover table-striped table-row-bordered nowrap">
                        ...
                        <tbody>
                            <?php
                            foreach( $allShiftOverrideEntries as $ShiftOverrideEntry){
                            ?>
                                <tr>
                                    <td class="text-center bg-white">
                                        <?php echo $ShiftOverrideEntry['employee_id']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $ShiftOverrideEntry['employee_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $ShiftOverrideEntry['internal_employee_id']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $ShiftOverrideEntry['company_short_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $ShiftOverrideEntry['department_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo date('d M, Y', strtotime($ShiftOverrideEntry['from_date'])); ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo date('d M, Y', strtotime($ShiftOverrideEntry['to_date'])); ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <?php echo $ShiftOverrideEntry['shift_name']; ?>
                                    </td>
                                    <td class="text-center bg-white">
                                        <p class="text-wrap mx-auto mb-0 lh-sm" style="width: 150px"><small><?php echo $ShiftOverrideEntry['remarks']; ?></small></p>
                                    </td>
                                    <td class="text-center bg-white">
