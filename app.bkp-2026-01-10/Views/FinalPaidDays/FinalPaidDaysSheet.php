...
<div class="row gy-5 g-xl-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="filter_form" class="row gy-5 g-xl-8" enctype='multipart/form-data'>
                        ...
                        <?php
                        if (session()->get('current_user')['employee_id'] == '40' || session()->get('current_user')['employee_id'] == '93' || session()->get('current_user')['employee_id'] == '461') {
                        ?>
                            <div class="col-lg-2">
                                <label class="form-label"> &nbsp; </label><br>
    ...
    <div class="col-12 table-responsive">
        ...
        <table id="final_paid_days_report" class="table table-custom table-hover nowrap">
            ...
            <tbody>
                <?php
                foreach ($HRSHEETData as $key => $data) {
                ...
                ?>
                    <tr class="main-row row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Shift start</strong>
                            </p>
                        </td>
                        <!-- date -->
                        <?php
                        ...
                        <td class="text-center">
                            <span class="d-block w-100 border-bottom">
                                <?php
                                echo array_sum(array_column($PreFinalPaidDays_Data, 'late_coming_grace'))
                        ...
                        <td class="text-center">
                            ...
                            echo count($All_HD) + count($All_HD_plus_cl_by2) + count($All_HD_plus_CompOff_by2) + count($All_HD_plus_ul_by2) + count($All_HD_plus_hl_by2) + count($All_HD_plus_el_by2);
                            ?>
                        </td>
                        <!-- Adjusted Incentives -->
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            ...
                            echo count($All_OD) + count($All_OD_by2) / 2 + count($All_OD_by2_plus_comp_off_by2) / 2 + count($All_OD_by2_plus_cl_by2) / 2 + count($All_OD_by2_plus_ul_by2) / 2 + count($All_OD_by2_hl_by2) / 2 + count($All_OD_by2_el_by2) / 2;
                            ?>
                        </td>
                        <!-- COMP OFF -->
                        <td class="text-center">
                        ...
                        <td class="text-center">
                            ...
                            echo count($All_NH) + count($All_HL) + (count($All_HL_by2) / 2) + (count($All_HD_plus_hl_by2) / 2) + (count($All_OD_by2_hl_by2) / 2);
                            ?>
                        </td>
                        <!-- holiday -->
                        <td class="text-center">
                        ...
                        <!-- <td class="text-center">
                            ...
                            echo (count($All_HD_el_by2) / 2) + (count($All_OD_by2_el_by2) / 2);
                            ?>
                        </td> -->
                        <!-- CL -->
                        <td class="text-center">
                        ...
                        <!-- Name for search -->
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px"><strong class="small"><?php echo $employee_name; ?> (<?php echo $company_short_name; ?>)</strong></p>
                        </td>
                    </tr>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Machine</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Punch in time (OD Included)</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Punch out time (OD Included)</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Late coming minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['late_coming_minutes']; ?>
                            </td>
                        <?php
                        }
                        ?>
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">
                                    <?php echo $employee_name; ?> (<?php echo $company_short_name; ?>)
                                </strong>
                            </p>
                        </td>
                    </tr>
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Early going minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['early_going_minutes']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Late coming grace</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['late_coming_grace']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Wave Off Minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Deduction Remarks</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <p class="text-wrap mb-0 lh-sm <?php echo @$PreFinalPaidDays_Data[$date]['deduction_minutes'] > 0 ? 'text-danger' : ''; ?>" style="width: 100px">
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Half Day Adjust from Grace minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Remarks of Half Day Adjust from Grace minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Extra Work Minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['ExtraWorkMinutes']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Late Sitting Minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['LateSittingMinutes']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Over Time Minutes</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['OverTimeMinutes']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Status remarks</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Leave request type</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['leave_request_type']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Leave request amount</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['leave_request_amount']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Leave request status</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['leave_request_status']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Paid Day</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['paid']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Settlement type</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['settlement_type']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Settlement</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['settlement']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Settlement remarks</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['settlement_remarks']; ?>
                            </td>
                        <?php
                        }
                        ?>
                    ...
                    <tr class="row-<?php echo $employee_code; ?>">
                        ...
                        <td class="text-center">
                            <p class="text-wrap mb-0 lh-sm" style="width: 100px">
                                <strong class="small">Settled by</strong>
                            </p>
                        </td>
                        <?php
                        foreach ($lastMonthDates as $date) {
                        ?>
                            <td class="text-center">
                                <?php echo @$PreFinalPaidDays_Data[$date]['settled_by_name']; ?>
                            </td>
                        <?php
                        }
                        ?>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        var regenerated = '<?php echo session()->getFlashdata('regenerated'); ?>';
        if (regenerated == 'yes') {
            Swal.fire({
                html: "<?php echo session()->getFlashdata('regenerated_message'); ?>",
                icon: "success",
                buttonsStyling: !1,
        ...
        $(document).on('click', '#regenerate_final_paid_days', function(e) {
            e.preventDefault();
            var reGenerateButton = $(this);
            reGenerateButton.attr("data-kt-indicator", "on");
            reGenerateButton.attr("disabled", "true");
            var company = $("#company").val();
            var department = $("#department").val();
            var employee = $("#employee").val();
            var month = $("#month").val();
            var link_to_regenerate = "<?php echo base_url('/backend/reports/final-paid-days/regenerate'); ?>?regenerate=yes";
            if (company.length) {
                $.each(company, function(index, value) {
                    link_to_regenerate += "&company[]=" + value;
                })
            }
            if (department.length) {
                $.each(department, function(index, value) {
                    link_to_regenerate += "&department[]=" + value;
                })
            }
            if (employee.length) {
                $.each(employee, function(index, value) {
                    link_to_regenerate += "&employee[]=" + value;
                })
            }
            if (month.length) {
                link_to_regenerate += "&month=" + month;
            }
            window.location.replace(link_to_regenerate);
        })
        ...
        var final_paid_days_report = $("#final_paid_days_report").DataTable({
            ...
            "buttons": [
                /*{
                    text: 'Show extra data',
                    className: 'btn btn-primary',
                    action: function ( e, dt, node, config ) {
                        final_paid_days_report.rows(':not(.main-row)').every(function() {
                            var row = this.node();
                            $(row).toggle();
                        });
                        this.text( this.text() == 'Show extra data' ? 'Hide extra data' : 'Show extra data' );
                    }
                },*/
                'excelHtml5',
            ],
