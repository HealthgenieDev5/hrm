    ...
    <form action="<?= esc($form_action) ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="min_experience" name="min_experience" placeholder=" " value="<?= esc($job->min_experience) ?>" required>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="max_experience" name="max_experience" placeholder=" " value="<?= esc($job->max_experience) ?>" required>
                        <span class="input-group-text">year</span>
