        ...
        <table id="salary_report" class="table table-row-bordered nowrap">
            <thead>
                <tr>
                    ...
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Basic Salary</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">HR Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Medical Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Conv. Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Special Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Fuel Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Vacation Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    <th class="text-center bg-light-warning"><strong><span class="d-block">Other Allow.</span><span class="d-block" style="font-size:0.6rem"> (Rate of pay) </span></strong></th>
                    ...
                    <th class="text-center bg-light-success"><strong><span class="d-block">Basic Salary</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">HR Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">Medical Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">Conv. Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">Special Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">Fuel Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">Vacation Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    <th class="text-center bg-light-success"><strong><span class="d-block">Other Allow.</span><span class="d-block" style="font-size:0.6rem"> (Earned) </span></strong></th>
                    ...
                    <th class="text-center bg-light-danger"><strong>PF</strong></th>
                    <th class="text-center bg-light-danger"><strong>ESI</strong></th>
                    <th class="text-center bg-light-danger"><strong>LWF</strong></th>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        var salary_report = $("#salary_report").DataTable({
            ...
            "ajax": {
                url: "<?= base_url('/ajax/backend/reports/salary/final-salary/load-salary') ?>",
                type: "POST",
            ...
            "columns": [{
                ...
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.basic_salary;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.house_rent_allowance;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.medical_allowance;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.conveyance;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.special_allowance;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.fuel_allowance;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.vacation_allowance ? row.salary_structure.vacation_allowance : 0;
                    }
                },
                {
                    data: "id",
                    render: function(data, type, row, meta) {
                        return row.salary_structure.other_allowance;
                    }
                },
                {
                    data: "id",
        ...
        $(document).on('click', '.show-detailed-salary', function(e) {
            ...
            if (salary_structure.lwf == 'yes') {
                ...
                modal.find('.structure-lwf_employer_contribution').html(parseFloat(((((salary_structure.gross_salary * 0.2) / 100 <= 34) ? (salary_structure.gross_salary * 0.2) / 100 : 34) * 2).toFixed(2)));
            } else {
                modal.find('.structure-lwf_employer_contribution_label').html('LWF Contributions');
