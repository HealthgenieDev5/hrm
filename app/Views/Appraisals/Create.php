                                        ...
                                        <div class="d-flex justify-content-between flex-wrap gap-3">
                                            ...
                                            <!-- <div class="form-group mb-5">
                                                ...
                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                    ...
                                                    <input class="form-check-input min-w-75px" type="checkbox" value="yes" id="enable_bonus" name="enable_bonus" <?= isset($lastAppraisal) && $lastAppraisal->enable_bonus == 'yes' ? 'checked' : '' ?>>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                    ...
                                                    <input class="form-check-input min-w-75px" type="checkbox" value="yes" id="pf" name="pf" <?= isset($lastAppraisal) && $lastAppraisal->pf == 'yes' ? 'checked' : '' ?>>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                    ...
                                                    <input class="form-check-input min-w-75px" type="checkbox" value="yes" id="esi" name="esi" <?= isset($lastAppraisal) && $lastAppraisal->esi == 'yes' ? 'checked' : '' ?>>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="form-check form-switch form-check-custom form-check-solid">
                                                    ...
                                                    <input class="form-check-input min-w-75px" type="checkbox" value="yes" id="lwf" name="lwf" <?= isset($lastAppraisal) && $lastAppraisal->lwf == 'yes' ? 'checked' : '' ?>>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            $(document).on('change', '#employee_name', function(e) {
                e.preventDefault();
                window.location.replace("<?php echo base_url('/backend/master/appraisals/employee'); ?>/" + $(this).val() + '/create');
            });
            ...
            $(document).on('submit', '#update_appraisals', function(e) {
                ...
                $.ajax({
                    method: "POST",
                    url: "<?php echo base_url('backend/master/appraisals'); ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            var appraisals_table = $("#appraisals_table").DataTable({
                ...
                "ajax": {
                    url: "<?= base_url('ajax/master/appraisals/table-by-empid/' . $employee_id) ?>",
                    type: "GET",
