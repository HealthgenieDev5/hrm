                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!-- <select class="form-control form-control-sm" id="probation" name="probation" data-control="select2" data-placeholder="Select Probation" data-allow-clear="true">
                                                    ...
                                                    <option value="45 Days Probation"
                                                        <?php
                                                        #echo set_select('probation', '45 Days Probation');
                                                        ?>>45 Days Probation</option>
                                                    <option value="90 Days Probation"
                                                        <?php
                                                        #echo set_select('probation', '90 Days Probation');
                                                        ?>>90 Days Probation</option>
                                                    <option value="confirmed"
                                                        <?php
                                                        #echo set_select('probation', 'confirmed');
                                                        ?>>Confirmed</option>
                                                </select> -->
                                        ...
                                        <div class="row mb-6">
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control form-control-sm" id="role" name="role" data-control="select2" data-placeholder="Select a Role" data-allow-clear="true">
                                                    ...
                                                    ?>
                                                            <option
                                                                <?php if ($role_row['role_name'] == 'superuser' && session()->get('current_user')['employee_id'] != 40) {
                                                                    echo 'disabled';
                                                                } ?>
