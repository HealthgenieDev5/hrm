    ...
    <form action="<?= esc($form_action) ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="min_budget" name="min_budget" placeholder=" " min="0" step="1" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="<?= esc($job->min_budget) ?>" required>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="max_budget" name="max_budget" placeholder=" " min="0" step="1" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="<?= esc($job->max_budget) ?>" required>
                        <span class="input-group-text">INR</span>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="min_experience" name="min_experience" placeholder=" " min="0" step="1" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="<?= esc($job->min_experience) ?>" required>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-3">
                <div class="form-floating mb-3">
                    <div class="input-group">
                        <input type="number" class="form-control" id="max_experience" name="max_experience" placeholder=" " min="0" step="1" oninput="this.value=this.value.replace(/[^0-9]/g,'')" value="<?= esc($job->max_experience) ?>" required>
                        <span class="input-group-text">year</span>
            ...
            <div class="col-6 col-md-6 col-lg-4 col-xl-4">
                <div class="form-floating mb-3">
                    <select class="form-select" id="specific_industry" name="specific_industry">
                        <option value="" disabled selected>Select Industry</option>
                        <?php if (!empty($job->specific_industry)): ?>
                            <option value="<?= esc($job->specific_industry) ?>" selected><?= esc($job->specific_industry) ?></option>
                        <?php endif; ?>
                    </select>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if ($('#specific_industry').hasClass('select2-hidden-accessible')) {
            $('#specific_industry').select2('destroy');
        }
        ...
        if (savedIndustry) {
            if ($('#specific_industry option[value="' + savedIndustry + '"]').length === 0) {
                var newOption = new Option(savedIndustry, savedIndustry, true, true);
                $('#specific_industry').append(newOption);
            }
        ...
        // Populate test summary on page load from pre-checked values
        (function initTestSummary() {
            ...
            if (other) summary.push(`Other: ${other}`);
