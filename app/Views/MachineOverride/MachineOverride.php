    ...
    <div class="row gy-5 g-xl-8">
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm mb-5">
                <form id="machine_override_form"class="card-body" method="post" enctype="multipart/form-data" >
                <!-- <div class="card-body"> -->
                    <div class="row">
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($){
            ...
            $(document).on('change', '#employee_id', function(e){              
                ...
                /*fetchOverrides( $(this).val() );*/
                $("#existing_overrides").DataTable().ajax.reload();
            })

            $(document).on('submit', '#machine_override_form', function(e){
                e.preventDefault();
                var form = $(this);
                ...
                $.ajax({
                    method: "post",
                    url: "<?php echo base_url('/ajax/backend/hr/override-machine'); ?>",
                    data: data,
                    processData: false,
                    contentType: false,
            ...
            const fetchOverrides = (employee_id) => {
                ...
                $.ajax({
                    method: "post",
                    url: "<?php echo base_url('/ajax/backend/hr/existing-machine-overrides'); ?>",
                    data: data,
                    success: function(response){
                        if( response.response_type == 'error' ){
                            if( response.response_description.length ){
            ...
            var existing_overrides = $("#existing_overrides").DataTable({
                "buttons": [],
                "ajax": {
                    url:  "<?= base_url('/ajax/backend/hr/existing-machine-overrides') ?>",
                    type:  "POST",
                    data:  { filter : function(){ return $('#machine_override_form').serialize(); } },
                    dataSrc: "",
                    ...
                    { 
                        ...
                        render: function(data, type, row, meta){
                            return `<div class="d-flex justify-content-center">
                                        <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm delete-machine-override" data-id="${row.id}">
            ...
            $(document).on('click', '.delete-machine-override', function(e){
                e.preventDefault();
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            method: "post",
                            url: "<?php echo base_url('/ajax/backend/hr/delete-machine-override'); ?>",
                            data: data,
                            success: function(response){
                                if( response.response_type == 'error' ){
                                    if( response.response_description.length ){
