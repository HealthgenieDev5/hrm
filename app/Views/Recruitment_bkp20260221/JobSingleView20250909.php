                        ...
                        <div class="card-body pt-9 pb-0">
                            ...
                            <div class="tab-content mt-4">
                                ...
                                <div class="tab-pane fade" id="tests<?= $job->id ?>">
                                    <p><strong>Technical Test:</strong> <?= esc($job->technical_test_required) ?></p>
                                    <p><strong>IQ Test:</strong> <?= esc($job->iq_test_required) ?></p>
                                    <p><strong>English Test:</strong> <?= esc($job->eng_test_required) ?></p>
                                    <p><strong>Operation Test:</strong> <?= esc($job->operation_test_required) ?></p>
                                    <p><strong>Any Other Test Required:</strong> <?= esc($job->other_test_required) ?></p>
                                </div>
                                ...
                                <div class="tab-pane fade" id="others<?= $job->id ?>">
                                    ...
                                    <div><?= nl2br(esc($job->educational_qualification)) ?></div>
                                    <p><strong>Job Description / Requirement:</strong></p>
                                    <div> <?php
                                            $requirement = json_decode($job->job_description, true);
                                            ...
                                            ?>
                                                    <p><?php echo $counter++ .  ': '; ?> <?= esc(trim($line)) ?></p>
                                        <?php
                                                    endif;
                                                endforeach;
                                            endif;
                                    ...
                                    <div><?= nl2br(esc($job->system_required)) ?></div>
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body" id="comments-section">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="card">
                                ...
                                <div class="timeline-label">
                                    ...
                                    <div class="timeline-item">
                                        <!--begin::Label-->
                                        <div class="timeline-label fw-bolder text-gray-800 fs-6"><?php echo date('dM Y H:i A'); ?></div>
                                        <!--end::Label-->
                                        <!--begin::Badge-->
                                        ...
                                        <div class="fw-mormal timeline-content text-muted ps-3">
                                            <div class="d-flex mb-3">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-circle symbol-45px me-5 symbol">
                                                    <img src="https://hrm.healthgenie.test/uploads/2022/09/302626679_823700348646936_5045534820125924218_n_2.jpg" alt="">
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Info-->
                                                <div class="d-flex flex-column flex-row-fluid p-3 shadow rounded-2">
                                                    ...
                                                    <div class="d-flex align-items-center flex-wrap mb-1">
                                                        <a href="#" class="text-gray-800 text-hover-primary fw-bolder me-2">Rahul</a>
                                                        <span class="text-gray-400 fw-bold fs-7">Open</span>
                                                        <a href="#" class="ms-auto text-gray-400 text-hover-primary fw-bold fs-7" data-bs-toggle="modal" data-bs-target="#reply_modal" data-comment_id="" data-post_id="">Reply</a>
                                                    </div>
                                                    <!--end::Info-->
                                                    <!--begin::Post-->
                                                    <span class="text-gray-800 fs-7 fw-normal pt-1">There is an issue , We will not be able to hire anyone if the salary is that low, As per our experience, for this position, minimum salary must be above 20k</span>
                                                    <!--end::Post-->
                                                </div>
                                                <!--end::Info-->
                                            </div>
                            ...
                            <div id="comments-container" class="comments-container  mt-5">
        ...
        function displayComments(comments) {
            ...
            comments.forEach(function(comment) {
                ...
                const profilePicture = comment.profile_picture ?
                    `<img src="${comment.profile_picture}" alt="${comment.sender_name}" class="comment-avatar me-3" />` :
                    `<div class="comment-avatar-placeholder me-3"><i class="bi bi-person-circle"></i></div>`;
                            ...
                            <div class="d-flex align-items-start mb-2">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div class="d-flex align-items-center">
                                            <strong class="me-2">${comment.sender_name || 'Unknown User'}</strong>
                                            <span class="badge ${typeBadgeClass} comment-type-badge">${typeLabel}</span>
                                        </div>
                                        <div class="comment-meta">
                                            <small title="${comment.created_at_formatted}">${comment.time_ago}</small>
                                        </div>
                                    </div>
